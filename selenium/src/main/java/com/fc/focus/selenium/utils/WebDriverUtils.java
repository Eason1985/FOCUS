...
public class WebDriverUtils {
	...
	public static WebElement by(WebDriver driver, int timeOutInSeconds, ElementFinder elementFinder, String locator) {
		return (new WebDriverWait(driver, timeOutInSeconds)).until(com.fc.focus.selenium.utils.ExpectedConditions.findElement(elementFinder, locator));
	}
	...
	public static Object runScript(CompoundMutator mutator, WebDriver driver, String locator) {
		return new WebDriverWait(driver, 10).until(com.fc.focus.selenium.utils.ExpectedConditions.runScript(mutator, locator));
	}
