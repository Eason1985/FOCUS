...
public class DriverCommandProcessor implements CommandProcessor, WrapsDriver {
	...
	public DriverCommandProcessor(String baseUrl, WebDriver driver) {
	...
	public DriverCommandProcessor(String baseUrl, Supplier<WebDriver> maker) {
		this.maker = maker;
	...
	public Supplier<WebDriver> getMaker() {
		return maker;
	}
